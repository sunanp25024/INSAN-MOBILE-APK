...
import { Users, FileUp, UserPlus, Edit, Trash2, CalendarIcon as LucideCalendarIcon, AlertCircle, Download, KeyRound } from 'lucide-react';
                    ...
                    <TableRow key={kurir.uid}>
                      ...
                      <TableCell className="text-center space-x-1">
                        ...
                        <Button
                            ...
                            disabled={isSubmitting || (currentUser?.role === 'MasterAdmin' && currentUser.uid === kurir.uid)}
                        >
                            <Trash2 size={16}/>
                        </Button>
                      </TableCell>
      ...
      <Dialog open={isResetPasswordDialogOpen} onOpenChange={setIsResetPasswordDialogOpen}>
        <DialogContent>
          ...
          <div className="py-4 space-y-2">
            <Label htmlFor="newPasswordKurir">Password Baru (minimal 6 karakter)</Label>
            <Input 
              id="newPasswordKurir" 
              type="text" 
              value={newPassword}
